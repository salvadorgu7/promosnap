...
const PILLARS = [
  {
    ...
    desc: "90 dias de dados para saber se o desconto é verdadeiro",
  },
  {
    icon: Store,
    ...
    desc: "Amazon, Mercado Livre, Shopee e Shein num só lugar",
  },
  {
    icon: ShieldCheck,
    ...
    desc: "Algoritmo que avalia desconto, frete, reputação e tendência",
  },
  {
    icon: Zap,
    ...
    desc: "Preços verificados automaticamente, várias vezes ao dia",
  },
  {
    icon: Bell,
    ...
    desc: "Avise-me quando o preço cair no produto que você quer",
  },
  {
    icon: BarChart3,
    ...
    desc: "Recomendações baseadas em dados, não em achismo",
  },
];
