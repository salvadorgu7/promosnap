...
export default function SocialProof({
  ...
  return (
    <section className="py-5 md:py-8 section-border-top">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Tabs */}
        <div className="flex gap-2 mb-3 md:mb-6 overflow-x-auto pb-1">
          {TABS.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-medium transition-all whitespace-nowrap border ${
                  isActive
