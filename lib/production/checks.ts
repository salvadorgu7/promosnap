...
const OPTIONAL_ENV_VARS = [
  { key: 'MERCADOLIVRE_APP_ID', altKey: 'ML_CLIENT_ID', label: 'Mercado Livre API', group: 'integrations' as CheckGroup },
  { key: 'MERCADOLIVRE_SECRET', altKey: 'ML_CLIENT_SECRET', label: 'Mercado Livre Secret', group: 'integrations' as CheckGroup },
...
function checkOptionalEnvVars(): ProductionCheck[] {
  return OPTIONAL_ENV_VARS.map(({ key, altKey, label, group }) => {
