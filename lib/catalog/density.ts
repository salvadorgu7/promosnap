...
export const PRIORITY_CATEGORIES = [
  {
    ...
    target: 200,
    reason:
      "Alta intenção de compra, forte potencial de comparação, ticket médio alto",
  ...
  },
  {
    ...
    anchorBrands: ["Apple", "Dell", "Lenovo", "Samsung", "Acer"],
    anchorQueries: [
      "MacBook Air M2",
      "MacBook Air M3",
      "notebook gamer",
  ...
  },
  {
    ...
    target: 150,
    reason:
      "Volume altíssimo de busca, muitos modelos, desconto frequente, impulso",
    anchorBrands: ["Nike", "Adidas", "New Balance", "Asics", "Puma"],
    anchorQueries: [
      "Nike Air Max",
      "Nike Air Force",
      "Adidas Ultraboost",
